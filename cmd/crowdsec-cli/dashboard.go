...
var (
	...
	metabaseContainerNetworks []string
...
cscli dashboard setup -l 0.0.0.0 -p 443 --password <password>
 `,
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			mb, err := metabase.SetupMetabase(cli.cfg().API.Server.DbConfig, metabaseListenAddress, metabaseListenPort, metabaseUser, metabasePassword, metabaseDBPath, dockerGroup.Gid, metabaseContainerID, metabaseImage, metabaseContainerNetworks)
			if err != nil {
				return err
			}
	...
	flags.StringSliceVar(&metabaseContainerNetworks, "network", nil, "Network to attach to the container")
