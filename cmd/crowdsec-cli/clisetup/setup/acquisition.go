...
func (a *AcquisitionSpec) WriteHeader(writer io.Writer) error {
...
`))
	...
	_, err = writer.Write([]byte("# cscli-checksum: " + checksum + "\n\n"))
	return err
}

func (a *AcquisitionSpec) Write(writer io.Writer) error {
	content, err := a.ToYAML()
	if err != nil {
		return err
	}
