...
func LoadAcquisition(ctx context.Context, cConfig *csconfig.Config, hub *cwhub.Hub) ([]acquisition.ConfiguredSource, error) {
	var datasources []acquisition.ConfiguredSource
