...
The output mechanism is composed of plugins. In order to store the bans for {{v0X.blockers.htmlname}}, at least one backend plugin must be loaded. Else, bans will not be stored and decisions cannot be applied. 
