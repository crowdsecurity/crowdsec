...
// IsAppsecAlert returns true if the alert was generated by the AppSec WAF engine.
// AppSec alerts have messages starting with "WAF block:" or "WAF out-of-band match:"
// as set in pkg/acquisition/modules/appsec/utils.go:AppsecEventGeneration
func (a *Alert) IsAppsecAlert() bool {
	if a.Message == nil {
		return false
	}

	return strings.HasPrefix(*a.Message, "WAF block:") ||
		strings.HasPrefix(*a.Message, "WAF out-of-band match:")
}
