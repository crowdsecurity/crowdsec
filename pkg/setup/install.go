...
func InstallHubItems(ctx context.Context, hub *cwhub.Hub, contentProvider cwhub.ContentProvider, input []byte, interactive, dryRun, verbose bool) error {
	...
	return plan.Execute(ctx, interactive, dryRun, verbose)
}
