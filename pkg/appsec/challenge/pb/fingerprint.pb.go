...
type FingerprintDevice struct {
	...
	Keyboard          *FingerprintDeviceKeyboard     `protobuf:"bytes,7,opt,name=keyboard,proto3" json:"keyboard,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *FingerprintDevice) GetKeyboard() *FingerprintDeviceKeyboard {
	if x != nil {
		return x.Keyboard
	}
	return nil
...
type FingerprintDeviceKeyboard struct {
	...
	LayoutSize    int32                  `protobuf:"varint,2,opt,name=layoutSize,proto3" json:"layoutSize,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FingerprintDeviceKeyboard) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *FingerprintDeviceKeyboard) GetLayoutSize() int32 {
	if x != nil {
		return x.LayoutSize
	}
	return 0
...
type FingerprintBrowser struct {
	...
	Ai                *FingerprintBrowserAI                `protobuf:"bytes,9,opt,name=ai,proto3" json:"ai,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *FingerprintBrowser) GetAi() *FingerprintBrowserAI {
	if x != nil {
		return x.Ai
	}
	return nil
...
type FingerprintBrowserAI struct {
	state                          protoimpl.MessageState `protogen:"open.v1"`
	SummarizerAvailability         string                 `protobuf:"bytes,1,opt,name=summarizerAvailability,proto3" json:"summarizerAvailability,omitempty"`
	SummarizerLanguageAvailability string                 `protobuf:"bytes,2,opt,name=summarizerLanguageAvailability,proto3" json:"summarizerLanguageAvailability,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
func (x *FingerprintBrowserAI) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *FingerprintBrowserAI) GetSummarizerAvailability() string {
	if x != nil {
		return x.SummarizerAvailability
	}
	return ""
}

func (x *FingerprintBrowserAI) GetSummarizerLanguageAvailability() string {
	if x != nil {
		return x.SummarizerLanguageAvailability
	}
	return ""
}
...
type FingerprintBrowserFeatures struct {
	...
	SumPrecise                bool                   `protobuf:"varint,30,opt,name=sumPrecise,proto3" json:"sumPrecise,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
func (x *FingerprintBrowserFeatures) GetSumPrecise() bool {
	if x != nil {
		return x.SumPrecise
	}
	return false
...
const file_fingerprint_proto_rawDesc = "" +
	...
	"playwright\x12B\n" +
	"\x1cnavigatorPropertyDescriptors\x18\x06 \x01(\tR\x1cnavigatorPropertyDescriptors\"\xa6\x03\n" +
	...
	"\fmediaQueries\x18\x06 \x01(\v2*.fingerprint.fingerprintDeviceMediaQueriesR\fmediaQueries\x12B\n" +
	"\bkeyboard\x18\a \x01(\v2&.fingerprint.fingerprintDeviceKeyboardR\bkeyboard\"\xd1\x02\n" +
	...
	"colorDepth\"S\n" +
	"\x19fingerprintDeviceKeyboard\x12\x16\n" +
	"\x06layout\x18\x01 \x01(\tR\x06layout\x12\x1e\n" +
	"\n" +
	"layoutSize\x18\x02 \x01(\x05R\n" +
	"layoutSize\"\x95\x04\n" +
	...
	"\rtoSourceError\x18\b \x01(\v2,.fingerprint.fingerprintBrowserToSourceErrorR\rtoSourceError\x121\n" +
	"\x02ai\x18\t \x01(\v2!.fingerprint.fingerprintBrowserAIR\x02ai\"\x96\x01\n" +
	"\x14fingerprintBrowserAI\x126\n" +
	"\x16summarizerAvailability\x18\x01 \x01(\tR\x16summarizerAvailability\x12F\n" +
	"\x1esummarizerLanguageAvailability\x18\x02 \x01(\tR\x1esummarizerLanguageAvailability\"\xc2\b\n" +
	...
	"\rotpCredential\x18\x1d \x01(\bR\rotpCredential\x12\x1e\n" +
	"\n" +
	"sumPrecise\x18\x1e \x01(\bR\n" +
	"sumPrecise\"\xef\x01\n" +
