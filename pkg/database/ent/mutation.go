...
// ApicAuthMutation represents an operation that mutates the ApicAuth nodes in the graph.
type ApicAuthMutation struct {
	config
	op            Op
	typ           string
	id            *int
	...
	oldValue      func(context.Context) (*ApicAuth, error)
	predicates    []predicate.ApicAuth
}

var _ ent.Mutation = (*ApicAuthMutation)(nil)

// apicauthOption allows management of the mutation configuration using functional options.
type apicauthOption func(*ApicAuthMutation)

// newApicAuthMutation creates new mutation for the ApicAuth entity.
func newApicAuthMutation(c config, op Op, opts ...apicauthOption) *ApicAuthMutation {
	m := &ApicAuthMutation{
		config:        c,
		op:            op,
		typ:           TypeApicAuth,
...
// withApicAuthID sets the ID field of the mutation.
func withApicAuthID(id int) apicauthOption {
	return func(m *ApicAuthMutation) {
		var (
			err   error
			once  sync.Once
			value *ApicAuth
		)
		m.oldValue = func(ctx context.Context) (*ApicAuth, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().ApicAuth.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withApicAuth sets the old ApicAuth of the mutation.
func withApicAuth(node *ApicAuth) apicauthOption {
	return func(m *ApicAuthMutation) {
		m.oldValue = func(context.Context) (*ApicAuth, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m ApicAuthMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m ApicAuthMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ApicAuthMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ApicAuthMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().ApicAuth.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *ApicAuthMutation) SetToken(s string) {
	m.token = &s
}

// Token returns the value of the "token" field in the mutation.
func (m *ApicAuthMutation) Token() (r string, exists bool) {
	v := m.token
	if v == nil {
		return
	}
...
// OldToken returns the old "token" field's value of the ApicAuth entity.
// If the ApicAuth object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ApicAuthMutation) OldToken(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ApicAuthMutation) ResetToken() {
	m.token = nil
}

// SetExpiration sets the "expiration" field.
func (m *ApicAuthMutation) SetExpiration(t time.Time) {
	m.expiration = &t
}

// Expiration returns the value of the "expiration" field in the mutation.
func (m *ApicAuthMutation) Expiration() (r time.Time, exists bool) {
	v := m.expiration
	if v == nil {
		return
	}
...
// OldExpiration returns the old "expiration" field's value of the ApicAuth entity.
// If the ApicAuth object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ApicAuthMutation) OldExpiration(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ApicAuthMutation) ResetExpiration() {
	m.expiration = nil
}

// SetSingleton sets the "singleton" field.
func (m *ApicAuthMutation) SetSingleton(s string) {
	m.singleton = &s
}

// Singleton returns the value of the "singleton" field in the mutation.
func (m *ApicAuthMutation) Singleton() (r string, exists bool) {
	v := m.singleton
	if v == nil {
		return
	}
...
// OldSingleton returns the old "singleton" field's value of the ApicAuth entity.
// If the ApicAuth object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ApicAuthMutation) OldSingleton(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ApicAuthMutation) ResetSingleton() {
	m.singleton = nil
}

// Where appends a list predicates to the ApicAuthMutation builder.
func (m *ApicAuthMutation) Where(ps ...predicate.ApicAuth) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the ApicAuthMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *ApicAuthMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ApicAuth, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *ApicAuthMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *ApicAuthMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (ApicAuth).
func (m *ApicAuthMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *ApicAuthMutation) Fields() []string {
	fields := make([]string, 0, 3)
	if m.token != nil {
		fields = append(fields, apicauth.FieldToken)
	}
	if m.expiration != nil {
		fields = append(fields, apicauth.FieldExpiration)
	}
	if m.singleton != nil {
		fields = append(fields, apicauth.FieldSingleton)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *ApicAuthMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *ApicAuthMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case apicauth.FieldToken:
	...
	return nil, fmt.Errorf("unknown ApicAuth field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ApicAuthMutation) SetField(name string, value ent.Value) error {
	switch name {
	case apicauth.FieldToken:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown ApicAuth field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *ApicAuthMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *ApicAuthMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ApicAuthMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown ApicAuth numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *ApicAuthMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *ApicAuthMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *ApicAuthMutation) ClearField(name string) error {
	return fmt.Errorf("unknown ApicAuth nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *ApicAuthMutation) ResetField(name string) error {
	switch name {
	case apicauth.FieldToken:
		m.ResetToken()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *ApicAuthMutation) AddedEdges() []string {
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *ApicAuthMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *ApicAuthMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *ApicAuthMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *ApicAuthMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *ApicAuthMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *ApicAuthMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown ApicAuth unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *ApicAuthMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown ApicAuth edge %s", name)
}
