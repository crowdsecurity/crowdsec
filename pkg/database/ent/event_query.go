...
func (_q *EventQuery) QueryOwner() *AlertQuery {
...
func (_q *EventQuery) WithOwner(opts ...func(*AlertQuery)) *EventQuery {
	query := (&AlertClient{config: _q.config}).Query()
...
func (_q *EventQuery) loadOwner(ctx context.Context, query *AlertQuery, nodes []*Event, init func(*Event), assign func(*Event, *Alert)) error {
