...
| `ENROLL_KEY_FILE`           |                                    | Path to a file containing the enroll key retrieved from [the console](https://app.crowdsec.net/) to enroll the instance. Must not be used together with `ENROLL_KEY`.                                                     |
