...
@test "cscli alerts list, human/json/raw" {
    ...
    assert_line --regexp "\[\"cscli\",\"manual 'ban' from 'githubciXXXXXXXXXXXXXXXXXXXXXXXX([a-zA-Z0-9]{16})?'\",\"Ip\",null,\"ban\",\"10.20.30.40\"\]"
...
@test "cscli alerts inspect" {
    ...
    assert_output --regexp "\[\"cscli\",\"manual 'ban' from 'githubciXXXXXXXXXXXXXXXXXXXXXXXX.*'\",\"Ip\",null,\"ban\",\"10.20.30.40\"\]"
