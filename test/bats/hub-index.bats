...
@test "malformed index - null item" {
    ...
    assert_stderr --partial "failed to parse hub index: parsers:author/pars1 has no index metadata."
}
...
@test "malformed index - no download path" {
    ...
    rune -1 cscli hub list
    assert_stderr --partial "failed to parse hub index: parsers:author/pars1 has no download path."
}
...
@test "malformed parser - no stage" {
    ...
    assert_stderr --partial "failed to parse hub index: parsers:author/pars1 has no stage."
}
